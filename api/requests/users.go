...
type ListUsersInput struct {
	...
	RefSignupsTo            *int             `json:"ref_signups_to" validate:"omitempty,min=0"`
	ProdRefSignupsFrom      *int             `json:"p_ref_signups_from" validate:"omitempty,min=0"`
	ProdRefSignupsTo        *int             `json:"p_ref_signups_to" validate:"omitempty,min=0"`
	ProdRefBoughtFrom       *int             `json:"p_ref_bought_from" validate:"omitempty,min=0"`
	ProdRefBoughtTo         *int             `json:"p_ref_bought_to" validate:"omitempty,min=0"`
	WholeDynDiscPercentFrom *decimal.Decimal `json:"whole_ddp_from" validate:"omitempty,decimalpercent"`
	WholeDynDiscPercentTo   *decimal.Decimal `json:"whole_ddp_to" validate:"omitempty,decimalpercent"`
	DynDiscPercentFrom      *decimal.Decimal `json:"ddp_from" validate:"omitempty,decimalpercent"`
	DynDiscPercentTo        *decimal.Decimal `json:"ddp_to" validate:"omitempty,decimalpercent"`
	BonusPointsFrom         *decimal.Decimal `json:"bonus_from" validate:"omitempty,decimalgtezero"`
	BonusPointsTo           *decimal.Decimal `json:"bonus_to" validate:"omitempty,decimalgtezero"`
