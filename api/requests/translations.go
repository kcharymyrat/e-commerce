...
type CreateTranslationInput struct {
	...
	TableName       string    `json:"table_name" validate:"min=1"`
	FieldName       string    `json:"field_name" validate:"min=1"`
...
type PartialUpdateTranslationInput struct {
	...
	TableName       *string    `json:"table_name,omitempty" validate:"omitempty,min=1"`
	FieldName       *string    `json:"field_name,omitempty" validate:"omitempty,min=1"`
